...
public class RedisUtil{
     ...
     * @return
     */
    public Long pfadd(String key,String value,int indexdb){
        Jedis jedis = null;
        try {
            jedis = jedisPool.getResource();
            jedis.select(indexdb);
    ...
    public String pfmerge(String destKey,int index,String... sourceKey){
        Jedis jedis = null;
        try{
            jedis = jedisPool.getResource();
            jedis.select(index);
            return jedis.pfmerge(destKey,sourceKey);
        }catch (Exception e){
            log.error(e.getMessage());
            return "";
        }finally {
